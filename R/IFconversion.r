                                                  ...
                                                  u =round(mean(c(min(primary[,-1],na.rm = TRUE),max(primary[,-1],na.rm = TRUE)))),u_is_neutral =TRUE) #cut level
{
  ...
  #   calculate mi as number of items larger than cut value,
  #   calculate ni as number of items lower than cut value,
  #   calculate mi as number of items equal to cut value or not set
