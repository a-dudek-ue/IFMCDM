...
{
  # STEP 1 - check the integrity of the parameters given to function
  ...
  # STEP 2 Calculate ideal object and anti-ideal object coordinates
  if(length(p)==1){
    pattern<-NULL
    apattern<-NULL
    for(i in 1:(ncol(data)%/%3)){
  ...
  # STEP 3 Calculate the distances between ideal , anti-ideal object and objects in dataset
  ...
  # STEP 4 Arrange the Objects due to distance calculated in step 3 
